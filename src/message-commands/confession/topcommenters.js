...
module.exports = {
    name: "topcommenters",
    aliases: ["topcommenter", "topcomment", "commenters"],
    description: "Xem top commenters có nhiều comments nhất",
    usage: "!topcommenters [limit]\n\nExamples:\n- !topcommenters 10\n- !topcommenters 5\n- !topcommenters",
    category: "confession",
    ...
    async execute(message, args) {
        try {
            ...
            if (topCommenters.length === 0) {
                return message.reply("❌ Không có commenters nào!");
            }
            ...
            console.error('❌ Error in topcommenters message command:', error);
            await message.reply({
